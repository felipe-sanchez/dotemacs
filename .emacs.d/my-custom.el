...
(custom-set-variables
 ...
 '(ess-own-style-list
   (quote
    ((ess-indent-offset . 4)
     ...
     (ess-indent-with-fancy-comments . f))))
 '(ess-smart-S-assign-key "_")
 ...
 '(graphene-default-font "Source Code Pro-14")
 '(graphene-errors-auto nil)
 '(graphene-fixed-pitch-font "Source Code Pro-14")
 ...
 '(org-agenda-files
   (quote
    ("~/Projects/Notes/Life.org" "~/Projects/Plans/Website/TODO.org" "~/Dropbox/Org/Today.org" "~/Projects/Plans/plans.org")))
...
(quote
 (ein py-smart-operator company-jedi anaconda-mode jedi-direx zenburn-theme yascroll yaml-mode writegood-mode w3m visual-regexp-steroids virtualenv undo-tree twilight-theme twilight-bright-theme tabbar sunny-day-theme sublime-themes spacemacs-theme soothe-theme solarized-theme soft-stone-theme soft-morning-theme smooth-scroll smartscan smart-mode-line skewer-mode scss-mode rainbow-mode rainbow-delimiters quickrun python-environment projectile pretty-mode polymode phoenix-dark-pink-theme outshine org-bullets org nyan-mode nose nodejs-repl noctilux-theme multi-term monokai-theme mmm-mode markdown-mode magit lua-mode lorem-ipsum load-theme-buffer-local light-soap-theme leuven-theme less-css-mode latex-preview-pane key-chord json-mode ipython inkpot-theme imenu-anywhere iedit idomenu icicles html-script-src highlight-parentheses helm-company helm-R gruber-darker-theme graphene grandshell-theme github-browse-file git-gutter-fringe gandalf-theme fuzzy flatui-theme flatland-theme fish-mode find-temp-file feature-mode eyebrowse ess-smart-underscore ess-R-data-view espresso-theme elscreen elpy electric-operator ein-mumamo edbi-sqlite ecb discover-my-major discover dash-at-point colorsarenice-theme color-theme-solarized color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized color-theme-buffer-local centered-window-mode cdnjs c-eldoc bubbleberry-theme browse-kill-ring better-defaults auto-complete-clang-async auto-complete-clang auctex anzu anything anti-zenburn-theme ample-zen-theme ample-theme alect-themes afternoon-theme ack-and-a-half achievements ace-jump-mode)))
...
(quote
 ((eval org-toggle-latex-fragment)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(ess-%op%-face ((t (:inherit font-lock-keyword-face :slant normal :weight bold))))
